...
@section('container')
    ...
    <div class="w-full h-full mt-16 sm:mt-0">
        ...
        <div class="absolute inset-0 flex flex-col items-start justify-center px-10">
            <div class="flex flex-col w-1/3 mx-5">
                ...
                <p class="text-white text-md sm:text-xl md:text-xl font-sm">The Imperial Forces -- under orders from cruel
                    Darth Vader (David Prowse) -- hold Princess Leia (Carrie Fisher) hostage, in their efforts to quell the
                    rebellion against the Galactic Empire. Luke Skywalker (Mark Hamill) and Han Solo (Harrison Ford),
                    captain of the Millennium Falcon, work together with the companionable droid duo R2-D2 (Kenny Baker) and
                    C-3PO (Anthony Daniels) to rescue the beautiful princess, help the Rebel Alliance, and restore freedom
                    and justice to the Galaxy.</p>
            </div>
    ...
    {{-- Movies --}}
    <div class="p-10 ">
        <p class="bg-cstmdark rounded-md shadow-sm text-white text-4xl font-bold text-center py-5 mb-10">Popular on Indflix
        </p>
        {{-- Movie Card --}}
