...
@section('container')
    ...
    <div>
        <div>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore ut molestias hic quas modi, libero quia quaerat quam quis culpa explicabo repudiandae eligendi nostrum quae beatae maxime dolorem consequatur, molestiae corrupti ipsum deserunt officiis atque mollitia odio. Ad eaque sunt omnis modi quod temporibus recusandae repellendus voluptatibus unde, facilis cupiditate?</p>
        </div>
    </div>
@endsection
