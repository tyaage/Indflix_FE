            ...
            <div class="p-12 space-y-4  sm:p-12">
                ...
                <form class="space-y-4 md:space-y-6" method="post">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" id="password" placeholder="Kata sandi (Minimal 8 karakter)" class="text-cstmdark sm:text-sm rounded-lg block w-full p-2.5" required>
                    </div>

                    {{-- Masukan ulang password --}}
                    <div class="mb-10">
                        {{-- <label for="password" class="block mb-2 text-sm font-medium text-gray-900">Password</label> --}}
                        <input type="password" name="password" id="password" placeholder="Masukkan ulang kata sandi" class="text-cstmdark sm:text-sm rounded-lg block w-full p-2.5" required>
                    </div>
